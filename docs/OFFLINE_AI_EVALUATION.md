...
This source-only restoration proposes coverage of 90 of the prior 96 scopes (15 retained, 61 earlier exact restorations, 14 source-reviewed restorations), without provider generation. Six remain withheld: three lack an intact source/legacy-claim proof (`332894:superconducting-qubits`, `363375`, `eere-exchange:DE-TA1-0003589`); three have retained role quotes absent from the current exact scope (`356953`, `363179`, `357493`). They are pending reassessment, not scientific rejections or removals. New source/claim/projection changes invalidate these narrowly bound proofs normally.
