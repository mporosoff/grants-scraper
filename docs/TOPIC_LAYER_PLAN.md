...
| **§18.3a's bare-numbered prohibition** | **OPEN — assigned** | **P7 (P7.4)** | `Fm2` starts | Converted in 8.5 from a flat refusal into **four exit criteria**. This closeout does **not** waive them |
