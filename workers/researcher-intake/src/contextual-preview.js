...
import continuation from '../config/contextual-iteration3-continuation-preview-v1.json' with {type:'json'};
export function previewResponse(path){
  const selected=path.startsWith(continuation.base_path)?continuation:path.startsWith(iteration3.base_path)?iteration3:path.startsWith(iteration2.base_path)?iteration2:bundle;
