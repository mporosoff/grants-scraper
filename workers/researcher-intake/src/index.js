...
function corsHeaders(origin, env) {
  return origin && origin === env.PUBLIC_APP_ORIGIN ? {
...
function requirePublicOrigin(request, env) {
  ...
  if (origin !== env.PUBLIC_APP_ORIGIN && !/^http:\/\/(?:localhost|127\.0\.0\.1)(?::[0-9]+)?$/.test(origin)) {
