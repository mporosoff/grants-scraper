...
The September 13, 2026 build contains 1,418 open or current forecasted funding
opportunities (1,078 posted and 340 forecasted) rather than the former 48-record
...
EERE Exchange (1), Grants.gov (1,314), NASA ROSES (3), NYSERDA (37), National Science
...
The September 13, 2026 catalog contains 1,418 current posted or forecasted
opportunities:
...
- 370 preserve an official deadline time or timezone;
- 111 carry a preliminary-stage signal, including 2 narrative dates visibly marked for
  verification;
- 593 (41.8%) have an official per-award floor or ceiling;
- 869 (61.3%) have at least one structured funding amount; and
