...
The September 14, 2026 build contains 1,416 open or current forecasted funding
opportunities (1,075 posted and 341 forecasted) rather than the former 48-record
engineering shortlist. It contains no record with a deadline before the catalog date.
Current published sources are ARPA-H (10), DARPA / IARPA research solicitations (4), DOE
EERE Exchange (1), Grants.gov (1,310), NASA ROSES (3), NYSERDA (37), National Science
Foundation (11), U.S. National Science Foundation (1), VPR funding digest (limited
submissions & foundations) (39); additional sources are enabled only after a sustainable
...
The September 14, 2026 catalog contains 1,416 current posted or forecasted
opportunities:

- 277 have a defensible direct announcement attachment (187 high confidence, 90 medium
  confidence);
- another 630 use an official source page as their primary route;
- the remaining 509 use the official Grants.gov record as their primary route;
- 729 contain an agency notice URL across all route types;
- 373 preserve an official deadline time or timezone;
- 112 carry a preliminary-stage signal, including 2 narrative dates visibly marked for
  verification;
- 589 (41.6%) have an official per-award floor or ceiling;
- 865 (61.1%) have at least one structured funding amount; and
...
| August 29, 2026 | Keep deterministic Program Officer award navigation snapshot-native: exact same-source contact post-validation, immutable UTC year scopes, server-authoritative totals/facets, and bounded full-snapshot retrieval without a new identity store, corpus, database, or AI dependency for browsing or aggregate facts. |
| August 30, 2026 | Treat open-ended Program Officer topical Q&A as an explicitly provider-gated AI feature: use provider-native structured plans, deterministic complete-snapshot evidence selection, and bounded cited synthesis while preserving keyless portfolio browsing and aggregate facts. Reject ambiguous alphabetic two-letter scientific abbreviations instead of inferring notation. |
