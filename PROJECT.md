...
The September 15, 2026 build contains 1,410 open or current forecasted funding
opportunities (1,062 posted and 348 forecasted) rather than the former 48-record
...
EERE Exchange (1), Grants.gov (1,305), NASA ROSES (3), NYSERDA (38), National Science
Foundation (12), U.S. National Science Foundation (1), VPR funding digest (limited
submissions & foundations) (37); additional sources are enabled only after a sustainable
...
The September 15, 2026 catalog contains 1,410 current posted or forecasted
opportunities:

- 272 have a defensible direct announcement attachment (184 high confidence, 88 medium
  confidence);
- another 625 use an official source page as their primary route;
- the remaining 513 use the official Grants.gov record as their primary route;
- 723 contain an agency notice URL across all route types;
- 367 preserve an official deadline time or timezone;
- 110 carry a preliminary-stage signal, including 2 narrative dates visibly marked for
  verification;
- 578 (41.0%) have an official per-award floor or ceiling;
- 853 (60.5%) have at least one structured funding amount; and
