...
The August 9, 2026 build contains 1,497 open or current forecasted funding opportunities
(1,212 posted and 285 forecasted) rather than the former 48-record engineering
shortlist. It contains no record with a deadline before the catalog date. Current
published sources are Grants.gov (1,443), NYSERDA (37), UR VPR funding digest (limited
submissions & foundations) (17); additional sources are enabled only after a sustainable
...
The August 9, 2026 catalog contains 1,497 current posted or forecasted opportunities:
...
- 155 carry a preliminary-stage signal, including 3 narrative dates visibly marked for
  verification;
- 676 (45.2%) have an official per-award floor or ceiling;
- 977 (65.3%) have at least one structured funding amount; and
