...
The August 3, 2026 build contains 1,492 open or current forecasted funding opportunities
(1,225 posted and 267 forecasted) rather than the former 48-record engineering
shortlist. It contains no record with a deadline before the catalog date. Current
published sources are Grants.gov (1,455), NYSERDA (37); additional sources are enabled
...
The August 3, 2026 catalog contains 1,492 current posted or forecasted opportunities:

- 436 have a defensible direct announcement attachment (261 high confidence, 175 medium
  confidence);
...
- 763 contain an agency notice URL across all route types;
- 425 preserve an official deadline time or timezone;
- 141 carry a preliminary-stage signal, including 3 narrative dates visibly marked for
  verification;
- 695 (46.6%) have an official per-award floor or ceiling;
- 980 (65.7%) have at least one structured funding amount; and
