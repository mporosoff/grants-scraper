...
The August 24, 2026 build contains 1,448 open or current forecasted funding
opportunities (1,136 posted and 312 forecasted) rather than the former 48-record
...
The August 24, 2026 catalog contains 1,448 current posted or forecasted opportunities:

- 346 have a defensible direct announcement attachment (227 high confidence, 119 medium
  confidence);
- another 626 use an official source page as their primary route;
...
- 142 carry a preliminary-stage signal, including 1 narrative dates visibly marked for
  verification;
- 647 (44.7%) have an official per-award floor or ceiling;
- 922 (63.7%) have at least one structured funding amount; and
