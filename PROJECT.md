...
The September 16, 2026 build contains 1,390 open or current forecasted funding
opportunities (1,045 posted and 345 forecasted) rather than the former 48-record
...
EERE Exchange (1), Grants.gov (1,299), NASA ROSES (3), NYSERDA (37), U.S. National
...
The September 16, 2026 catalog contains 1,390 current posted or forecasted
opportunities:

- 269 have a defensible direct announcement attachment (182 high confidence, 87 medium
  confidence);
- another 610 use an official source page as their primary route;
- the remaining 511 use the official Grants.gov record as their primary route;
- 707 contain an agency notice URL across all route types;
- 354 preserve an official deadline time or timezone;
- 111 carry a preliminary-stage signal, including 2 narrative dates visibly marked for
  verification;
- 576 (41.4%) have an official per-award floor or ceiling;
- 850 (61.2%) have at least one structured funding amount; and
