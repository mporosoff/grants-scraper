...
The August 11, 2026 build contains 1,487 open or current forecasted funding
opportunities (1,199 posted and 288 forecasted) rather than the former 48-record
engineering shortlist. It contains no record with a deadline before the catalog date.
Current published sources are Grants.gov (1,433), NYSERDA (37), UR VPR funding digest
...
The August 11, 2026 catalog contains 1,487 current posted or forecasted opportunities:

- 402 have a defensible direct announcement attachment (253 high confidence, 149 medium
  confidence);
- another 634 use an official source page as their primary route;
- the remaining 451 use the official Grants.gov record as their primary route;
...
- 155 carry a preliminary-stage signal, including 3 narrative dates visibly marked for
  verification;
- 665 (44.7%) have an official per-award floor or ceiling;
- 967 (65.0%) have at least one structured funding amount; and
