...
The August 2, 2026 build contains 1,496 open or current forecasted funding opportunities
(1,230 posted and 266 forecasted) rather than the former 48-record engineering
shortlist. It contains no record with a deadline before the catalog date. Current
published sources are Grants.gov (1,459), NYSERDA (37); additional sources are enabled
...
The August 2, 2026 catalog contains 1,496 current posted or forecasted opportunities:

- 437 have a defensible direct announcement attachment (262 high confidence, 175 medium
  confidence);
- another 627 use an official source page as their primary route;
- the remaining 432 use the official Grants.gov record as their primary route;
- 764 contain an agency notice URL across all route types;
- 412 preserve an official deadline time or timezone;
- 138 carry a preliminary-stage signal, including 3 narrative dates visibly marked for
  verification;
- 699 (46.7%) have an official per-award floor or ceiling;
- 984 (65.8%) have at least one structured funding amount; and
