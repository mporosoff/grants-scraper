...
- 346 have a defensible direct announcement attachment (227 high confidence, 119 medium
  confidence);
- another 633 use an official source page as their primary route;
- the remaining 476 use the official Grants.gov record as their primary route;
- 750 contain an agency notice URL across all route types;
...
- 142 carry a preliminary-stage signal, including 1 narrative dates visibly marked for
  verification;
- 647 (44.5%) have an official per-award floor or ceiling;
- 922 (63.4%) have at least one structured funding amount; and
