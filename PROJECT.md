...
The August 4, 2026 build contains 1,491 open or current forecasted funding opportunities
(1,226 posted and 265 forecasted) rather than the former 48-record engineering
shortlist. It contains no record with a deadline before the catalog date. Current
published sources are Grants.gov (1,454), NYSERDA (37); additional sources are enabled
...
The August 4, 2026 catalog contains 1,491 current posted or forecasted opportunities:

- 437 have a defensible direct announcement attachment (270 high confidence, 167 medium
  confidence);
- another 625 use an official source page as their primary route;
- the remaining 429 use the official Grants.gov record as their primary route;
- 756 contain an agency notice URL across all route types;
- 427 preserve an official deadline time or timezone;
- 144 carry a preliminary-stage signal, including 3 narrative dates visibly marked for
  verification;
- 690 (46.3%) have an official per-award floor or ceiling;
