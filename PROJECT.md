...
The September 20, 2026 build contains 1,368 open or current forecasted funding
opportunities (1,018 posted and 350 forecasted) rather than the former 48-record
...
EERE Exchange (1), Grants.gov (1,279), NASA ROSES (2), NYSERDA (37), National Science
...
The September 20, 2026 catalog contains 1,368 current posted or forecasted
opportunities:

- 262 have a defensible direct announcement attachment (178 high confidence, 84 medium
  confidence);
- another 598 use an official source page as their primary route;
- the remaining 508 use the official Grants.gov record as their primary route;
- 691 contain an agency notice URL across all route types;
- 334 preserve an official deadline time or timezone;
- 108 carry a preliminary-stage signal, including 2 narrative dates visibly marked for
  verification;
- 563 (41.2%) have an official per-award floor or ceiling;
- 828 (60.5%) have at least one structured funding amount; and
