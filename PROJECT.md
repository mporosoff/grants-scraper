...
The September 15, 2026 build contains 1,398 open or current forecasted funding
opportunities (1,050 posted and 348 forecasted) rather than the former 48-record
...
EERE Exchange (1), Grants.gov (1,305), NASA ROSES (3), NYSERDA (38), U.S. National
Science Foundation (1), VPR funding digest (limited submissions & foundations) (37);
...
The September 15, 2026 catalog contains 1,398 current posted or forecasted
opportunities:

- 272 have a defensible direct announcement attachment (184 high confidence, 88 medium
  confidence);
- another 613 use an official source page as their primary route;
- the remaining 513 use the official Grants.gov record as their primary route;
- 711 contain an agency notice URL across all route types;
- 357 preserve an official deadline time or timezone;
- 110 carry a preliminary-stage signal, including 2 narrative dates visibly marked for
  verification;
- 578 (41.3%) have an official per-award floor or ceiling;
- 853 (61.0%) have at least one structured funding amount; and
