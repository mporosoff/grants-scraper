...
The August 12, 2026 build contains 1,469 open or current forecasted funding
opportunities (1,179 posted and 290 forecasted) rather than the former 48-record
engineering shortlist. It contains no record with a deadline before the catalog date.
Current published sources are Grants.gov (1,414), NYSERDA (37), U.S. National Science
...
The August 12, 2026 catalog contains 1,469 current posted or forecasted opportunities:
...
- 738 contain an agency notice URL across all route types;
...
- 153 carry a preliminary-stage signal, including 3 narrative dates visibly marked for
  verification;
- 668 (45.5%) have an official per-award floor or ceiling;
- 954 (64.9%) have at least one structured funding amount; and
