...
The September 9, 2026 build contains 1,422 open or current forecasted funding
opportunities (1,097 posted and 325 forecasted) rather than the former 48-record
...
EERE Exchange (1), Grants.gov (1,315), NASA ROSES (3), NYSERDA (37), National Science
...
The September 9, 2026 catalog contains 1,422 current posted or forecasted opportunities:

- 287 have a defensible direct announcement attachment (194 high confidence, 93 medium
  confidence);
...
- 736 contain an agency notice URL across all route types;
- 353 preserve an official deadline time or timezone;
- 112 carry a preliminary-stage signal, including 2 narrative dates visibly marked for
  verification;
- 603 (42.4%) have an official per-award floor or ceiling;
- 877 (61.7%) have at least one structured funding amount; and
