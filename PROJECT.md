...
The September 17, 2026 build contains 1,395 open or current forecasted funding
opportunities (1,043 posted and 352 forecasted) rather than the former 48-record
...
EERE Exchange (1), Grants.gov (1,302), NASA ROSES (3), NYSERDA (37), U.S. National
Science Foundation (1), VPR funding digest (limited submissions & foundations) (35);
...
The September 17, 2026 catalog contains 1,395 current posted or forecasted
opportunities:

- 266 have a defensible direct announcement attachment (178 high confidence, 88 medium
  confidence);
- another 612 use an official source page as their primary route;
- the remaining 517 use the official Grants.gov record as their primary route;
- 707 contain an agency notice URL across all route types;
- 352 preserve an official deadline time or timezone;
- 112 carry a preliminary-stage signal, including 2 narrative dates visibly marked for
  verification;
- 575 (41.2%) have an official per-award floor or ceiling;
- 850 (60.9%) have at least one structured funding amount; and
