...
The August 13, 2026 build contains 1,479 open or current forecasted funding
opportunities (1,188 posted and 291 forecasted) rather than the former 48-record
engineering shortlist. It contains no record with a deadline before the catalog date.
Current published sources are Grants.gov (1,423), NYSERDA (38), U.S. National Science
...
The August 13, 2026 catalog contains 1,479 current posted or forecasted opportunities:

- 402 have a defensible direct announcement attachment (252 high confidence, 150 medium
  confidence);
- another 617 use an official source page as their primary route;
- the remaining 460 use the official Grants.gov record as their primary route;
- 743 contain an agency notice URL across all route types;
...
- 153 carry a preliminary-stage signal, including 3 narrative dates visibly marked for
  verification;
- 674 (45.6%) have an official per-award floor or ceiling;
- 961 (65.0%) have at least one structured funding amount; and
