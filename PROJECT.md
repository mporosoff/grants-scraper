...
The August 5, 2026 build contains 1,490 open or current forecasted funding opportunities
(1,224 posted and 266 forecasted) rather than the former 48-record engineering
shortlist. It contains no record with a deadline before the catalog date. Current
published sources are Grants.gov (1,453), NYSERDA (37); additional sources are enabled
...
The August 5, 2026 catalog contains 1,490 current posted or forecasted opportunities:

- 436 have a defensible direct announcement attachment (270 high confidence, 166 medium
  confidence);
- another 623 use an official source page as their primary route;
- the remaining 431 use the official Grants.gov record as their primary route;
- 757 contain an agency notice URL across all route types;
- 431 preserve an official deadline time or timezone;
- 147 carry a preliminary-stage signal, including 3 narrative dates visibly marked for
  verification;
- 688 (46.2%) have an official per-award floor or ceiling;
- 979 (65.7%) have at least one structured funding amount; and
