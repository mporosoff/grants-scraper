...
test("cards remain title and abstract centric with responsive and accessible layouts", () => {
  ...
  assert.match(page, /header-context-pill" role="group" aria-label="NSF, NIH, DOE, and DoD award sources available"[\s\S]*?header-context-agencies[\s\S]*?header-context-agency">NSF[\s\S]*?header-context-separator">·[\s\S]*?header-context-agency">NIH[\s\S]*?header-context-row-break">·[\s\S]*?header-context-agency">DOE[\s\S]*?header-context-separator">·[\s\S]*?header-context-agency">DoD/);
