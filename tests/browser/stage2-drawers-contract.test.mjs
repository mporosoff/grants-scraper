...
test("protected algorithms, team output and AI request construction remain byte-identical", async () => {
  ...
  for (const [path, historicalExpected] of Object.entries(baseline.files)) {
    ...
    // Current evidence-repair authority also changes shared source evidence.
    // It is verified by focused source-policy and frozen query contracts.
    ...
    if (["assets/search-retrieval.js", "assets/team-researchers.js", "assets/team-matcher.js", "assets/opportunity-team.js"].includes(path)) continue;
