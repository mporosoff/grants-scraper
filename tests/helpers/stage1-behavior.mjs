...
const state={ready:true,searched:true,query:'carbon capture',sort:'relevance',filters:{agency:new Set(['NSF'])},profile:{active:false},refinement:{assessments:new Map()},ai:{assessments:new Map()},deployment:{review:{}},strongMatches:[{index:0}]};
