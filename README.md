...
the catalog date. It provides a direct official announcement for 393 records, an
official source-page route for another 599, and the official Grants.gov record for the
remaining 470. Across all route types, 732 records also contain an official source URL.
<!-- catalog-stats:end -->
