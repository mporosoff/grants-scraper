...
September 8, 2026 build contains 1,429 current funding opportunities (1,105 posted and
324 forecasted) from ARPA-H (9), DARPA / IARPA research solicitations (4), DOE EERE
Exchange (1), Grants.gov (1,324), NASA ROSES (3), NYSERDA (37), National Science
Foundation (10), U.S. National Science Foundation (1), VPR funding digest (limited
submissions & foundations) (40), with no deadline before the catalog date. It provides a
direct official announcement for 292 records, an official source-page route for another
637, and the official Grants.gov record for the remaining 500. Across all route types,
737 records also contain an official source URL.
<!-- catalog-stats:end -->
