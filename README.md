...
September 17, 2026 build contains 1,395 current funding opportunities (1,043 posted and
352 forecasted) from ARPA-H (12), DARPA / IARPA research solicitations (4), DOE EERE
Exchange (1), Grants.gov (1,302), NASA ROSES (3), NYSERDA (37), U.S. National Science
Foundation (1), VPR funding digest (limited submissions & foundations) (35), with no
deadline before the catalog date. It provides a direct official announcement for 266
records, an official source-page route for another 612, and the official Grants.gov
record for the remaining 517. Across all route types, 707 records also contain an
official source URL.
<!-- catalog-stats:end -->
