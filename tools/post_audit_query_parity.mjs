...
const hash=p=>createHash('sha256').update(fs.readFileSync(p)).digest('hex'),result={version:4,reference_query_sha256:hash('tests/fixtures/frozen/post-audit-search-query.js'),query_sha256:hash('assets/search-query.js'),engine_sha256:hash('assets/shared-team-engine.js'),scientific_scopes:scopes.size,comparisons,score_and_evidence_disagreements:0,prior_primary_and_all_option_lists_compared:groupsCompared,group_disagreements:0,skipped,clock,new_provider_calls:0};
fs.writeFileSync('docs/team-recommender/post-audit/query-cache-parity-v4.json',JSON.stringify(result,null,2)+'\n',{flag:'wx'});console.log(JSON.stringify(result));
