...
for(const cohort of ['rollout50','rollout150'])for(let sample=0;sample<3;sample++){
 ...
 await openFundingFinder(page);await runFundingSearch(page,'W911NF-23-S-0001');await page.waitForFunction(()=>document.querySelector('#find-funding').disabled===false);await page.waitForTimeout(1800);
 ...
 const trigger=page.locator('[data-opportunity-team="344592"]:is([data-opportunity-team-scope=""],[data-opportunity-team-scope="344592"])').first(),drawer=page.locator('#team-builder'),scope=cohort==='rollout50'?'344592:ab-0035':'344592:ab-0019';
