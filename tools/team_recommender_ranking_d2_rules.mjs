...
export function ruleEngine(inputCode) {
 let code=inputCode||execFileSync('git',['show','ec9c717cf1943ac68be4b1a4ba453bbb29dbd931:assets/team-recommender.js'],{encoding:'utf8'});
