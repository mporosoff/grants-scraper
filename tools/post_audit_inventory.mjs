...
const source = p => args['--runtime-ref'] && p.startsWith('assets/')
 ? execFileSync('git',['show',args['--runtime-ref']+':'+p],{encoding:'utf8'}) : fs.readFileSync(p,'utf8');
for(const p of ['assets/submission-schedule.js','assets/search-query.js','assets/search-retrieval.js','assets/team-matcher.js',engine,'data/opportunities.js','data/subtopics.js','data/researcher_directory.js','data/faculty_matches.js'])vm.runInContext(source(p),c);
