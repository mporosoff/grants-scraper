    ...
    <div class="help-dialog-body">
      ...
      <section class="help-section" id="help-results">
        ...
        <div class="help-feature-list">
          ...
          <div><strong>Ask AI</strong><span>Narrow to 100 or fewer results. Topic questions search that set and select up to 10 records. General comparisons start with the first 10 in the current order; follow-ups keep the previous answer’s records. Use a card’s More menu to discuss one opportunity.</span></div>
        </div>
